...
static void test_basicKS (void)
{
	...
	KeySet * ks =
		ksNew (30, keyNew ("user/tests/prettyexport/thomas", KEY_META, "pretty/index", "name", KEY_END),
		       ...
		       keyNew ("user/tests/prettyexport/thomas/shell", KEY_VALUE, "/usr/bin/zsh", "pretty/field", "#4", KEY_END),
		       keyNew ("user/tests/prettyexport/thomas/home", KEY_VALUE, "/home/thomas", "pretty/field", "#5", KEY_END),

...
static void test_basicKS (void)
{
	...
	KeySet * ks = ksNew (
		...
		keyNew ("user/tests/prettyexport/thomas/gecos", KEY_VALUE, "Thomas CENSORED", KEY_META, "pretty/field", "#1", KEY_END),
